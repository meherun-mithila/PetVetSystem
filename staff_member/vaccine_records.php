    ...
    <header class="bg-blue-600 text-white p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <span class="text-sm">Welcome, <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Staff Member'); ?></span>
        ...
        <div id="addVaccineForm" class="hidden bg-white rounded-lg shadow p-6 mb-6">
            ...
            <form method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="administered_by" value="<?php echo htmlspecialchars($staff_info['name'] ?? ''); ?>" placeholder="Doctor or Staff" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button onclick='editVaccine(<?php echo htmlspecialchars(json_encode($v), ENT_QUOTES, "UTF-8"); ?>)' class="text-blue-600 hover:text-blue-900">Edit</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
